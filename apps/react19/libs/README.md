...
| `babel.min.js` | @babel/standalone 7.29.7 | 浏览器端 JSX 转译 | 与 `apps/react18/libs/babel.min.js` 相同 |

## 与 React 18 模块的区别

- `apps/react18/` 仍使用官方 React **18.3.1** UMD，覆盖 class 组件与 Hooks 主干。
- `apps/react19/` 专讲 **React 19** 新 API，需本目录运行时方可运行 `useActionState` 等 demo。
