...
hero:
  ...
  text: 前端语法与框架复习
  tagline: 366 个可独立打开的 HTML Demo · 即开即学
  actions:
    - theme: brand
      text: 快速开始
...
| 分类                | 路径                            | demo 数 | 说明                          |
| ------------------- | ------------------------------- | ------: | ----------------------------- |
| JavaScript          | `apps/javascript/`              |     132 | 纯 JS，按 01–09 编号          |
| CSS                 | `apps/css/`                     |      44 | 布局、动画、响应式、现代特性  |
| Vue 2 / Vue 3       | `apps/vue2/` `apps/vue3/`       | 57 / 44 | 框架语法与原理                |
| React 18 / React 19 | `apps/react18/` `apps/react19/` | 54 / 11 | 函数组件 + 类组件 / 19 新特性 |
| TypeScript          | `apps/typescript/`              |      18 | 基础、进阶、工程化            |
| 综合 Demo           | `apps/demos/`                   |       6 | 拖拽、ViewPager、Todo 等      |
