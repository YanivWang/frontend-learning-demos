...
- 2026-05-27：完成 `apps/css/06-性能/01-重排重绘/index.html`、`02-合成层/index.html`、`apps/css/07-现代特性/07-content-visibility/index.html` 的权威化审核；`node scripts/report-demo-notes.mjs` 从 `167/357` 提升到 `170/357`，下一处失败为 `apps/css/07-现代特性/01-has选择器/index.html`。
...
- 2026-05-28：完成 `apps/react18/src/function-components/32-useLayoutEffect与useEffect对比.html` 至 `apps/react19/src/02-面试题/01-React19相对18变化速记.html` 共 10 个 demo 的权威化审核；`node scripts/report-demo-notes.mjs` 从 `325/357` 提升到 `335/357`，下一处失败为 `apps/react19/src/02-面试题/02-表单Action与useFormStatus.html`。
- 2026-05-28：完成 `apps/react19/src/02-面试题/02-表单Action与useFormStatus.html` 至 `apps/typescript/01-基础/06-class与implements.html` 共 10 个 demo 的权威化审核；`node scripts/report-demo-notes.mjs` 从 `335/357` 提升到 `345/357`，下一处失败为 `apps/typescript/01-基础/07-enum与对象枚举.html`。
- 2026-05-28：完成 `apps/typescript/01-基础/07-enum与对象枚举.html` 至 `apps/typescript/03-工程与框架/03-Vue3与React组件类型.html` 共 10 个 demo 的权威化审核；`node scripts/report-demo-notes.mjs` 从 `345/357` 提升到 `355/357`，下一处失败为 `apps/typescript/03-工程与框架/04-React表单与Vue-emits类型.html`。
- 2026-05-28：完成 `apps/typescript/03-工程与框架/04-React表单与Vue-emits类型.html` 与 `apps/typescript/mini-project/index.html` 共 2 个 demo 的权威化审核；`node scripts/report-demo-notes.mjs` 从 `355/357` 提升到 `357/357`，manifest 范围内 demo 学习内容全部达标。
