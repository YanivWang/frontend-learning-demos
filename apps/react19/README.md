...
专讲 **React 19** 新语法与高频面试点的 demo 模块。`apps/react19/src/` 下共 **11** 个 `.html`（基础语法 **6** + 面试题 **5**）。
...
- 先学 `apps/react18/src/function-components/` 的 Hooks 与渲染基础，再学本模块。
- `apps/react18/.../34-React19新特性概览.html` 为 **React 18 运行时** 下的概览；可运行 demo 以本目录为准。
